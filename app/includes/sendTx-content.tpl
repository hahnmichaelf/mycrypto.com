...
<div class="col-sm-8">
  ...
  <article class="block" ng-show="wallet.type=='addressOnly'">
    <div class="row form-group">
      ...
      <ul>
        <li class="u__protip">
          <a href="https://support.mycrypto.com/getting-started/accessing-your-new-eth-wallet.html"
             target="_blank"
        ...
        <li class="u__protip">
          <a href="https://support.mycrypto.com/private-keys-passwords/lost-eth-private-key.html"
             target="_blank"
             rel="noopener noreferrer"
        ...
        <li class="u__protip">
          <a href="https://support.mycrypto.com/private-keys-passwords/accessing-different-address-same-private-key-ether.html"
             target="_blank"
             rel="noopener noreferrer"
        ...
        <li class="u__protip">
          <a href="https://support.mycrypto.com/migration/"
             target="_blank"
             rel="noopener noreferrer"
             translate="X_HelpfulLinks_4">
                Migrating to/from MyCrypto
          </a>
        </li>
      </ul>
    </div>
  ...
  <article class="block" ng-hide="wallet.type=='addressOnly'">
    ...
    <!-- To Address -->
    <div class="row form-group">
      <address-field placeholder="0x4bbeEB066eD09B7AEd07bF39EEe0460DFa261520" var-name="tx.to"></address-field>
    </div>
